...
class RoundRobinMatcher:
    """Cycle through available responders in insertion order, ignoring distance.

    Ensures equal workload distribution when all responders are equidistant
    (e.g., station-based deployment). Falls back to first responder if only one exists.
    """
...
// Comment added for GitHub commit
